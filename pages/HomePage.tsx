...
const HomePage: React.FC = () => {
    ...
    return (
        <>
            <SEO 
                title="Magnetická reklama & Tisk na míru" 
                description="Výroba magnetických vizitek, reklam na auto a firemních kalendářů. Marketing, který drží a zaujme. Kvalitní tisk, rychlé dodání."
            />
