                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="p-8 bg-blue-50 rounded-2xl border border-blue-100 hover:shadow-md transition-shadow">
                            ...
                            <p className="text-gray-600">Obyčejnou vizitku každý dostal již tolikrát, že už nikoho nezaujme. Magnetická vizitka nebo kalendář ale klienta překvapí, zaujme a díky své originalitě i praktičnosti.</p>
                        </div>
                        <div className="p-8 bg-blue-50 rounded-2xl border border-blue-100 hover:shadow-md transition-shadow">
